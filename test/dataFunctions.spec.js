...
const nenStats = {"Especialista": 2, "Intensificador": 1, "Manipulador": 1, "Materializador": 1,}


describe('filterData', () => {
  it('Debe retornar un personaje con la ocupación `Brigada Fantasma`', () => {
    expect(filterData(fakeData, 'ocupation', 'Brigada Fantasma')).toEqual(BFOcupation);
  });

  it('Debe retornar un personaje con el tipo de Nen `Materializador`', () => {
    expect(filterData(fakeData, 'nenType', 'Materializador')).toEqual(matNenType);
  })
});
